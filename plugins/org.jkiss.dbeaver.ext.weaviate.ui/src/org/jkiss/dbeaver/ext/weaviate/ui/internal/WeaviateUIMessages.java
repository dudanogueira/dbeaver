...
public final class WeaviateUIMessages extends NLS {
    ...
    public static String query_group_by;
    public static String query_group_by_tip;
    public static String query_group_property;
    public static String query_group_none;
    public static String query_group_max_groups;
    public static String query_group_max_groups_tip;
    public static String query_group_objects_per_group;
    ...
    public static String query_server_default;
    public static String query_consistency;
    public static String query_consistency_tip;
    ...
    public static String query_diversify_limit_tip;
    ...
    public static String query_boost;
    public static String query_boost_tip;
    public static String query_boost_kind;
    public static String query_boost_none;
    public static String query_boost_property;
    public static String query_boost_property_tip;
    public static String query_boost_modifier;
    public static String query_boost_modifier_tip;
    public static String query_boost_origin;
    public static String query_boost_origin_tip;
    public static String query_boost_scale;
    public static String query_boost_scale_tip;
    public static String query_boost_offset;
    public static String query_boost_offset_tip;
    public static String query_boost_curve;
    public static String query_boost_weight;
    public static String query_boost_weight_tip;
    public static String query_boost_depth;
    public static String query_boost_depth_tip;
    ...
    public static String tenant_auto_creation_menu;
    public static String tenant_auto_activation_menu;
    public static String tenant_state_activate;
    public static String tenant_state_deactivate;
    public static String tenant_state_many;
    public static String tenant_auto_creation_enable;
    public static String tenant_auto_creation_disable;
    public static String tenant_auto_activation_enable;
    public static String tenant_auto_activation_disable;
    public static String tenant_auto_many;
    public static String tenant_auto_confirm;
    public static String tenant_auto_partial;
