...
public class WeaviateConnectionUrlTest extends DBeaverUnitTest {
    ...
    public void customHostAndPortAreUsed() {
        ...
        String url = provider.getConnectionURL(null, cfg);
        Assertions.assertEquals("http://weaviate.example.com:9090", url);
    }
    ...
    public void httpsSchemeIsRespected() {
        ...
        String url = provider.getConnectionURL(null, cfg);
        Assertions.assertEquals("https://cloud.weaviate.io:443", url);
    }
    ...
    public void defaultGrpcPort() {
        Assertions.assertEquals(50051, WeaviateConstants.DEFAULT_GRPC_PORT);
    }

    @Test
    public void defaultHttpPort() {
        Assertions.assertEquals(8080, WeaviateConstants.DEFAULT_HTTP_PORT);
    }
    ...
    public void cloudUrlIsReturnedForCloudConnection() {
        ...
        String url = provider.getConnectionURL(null, cfg);
        Assertions.assertEquals("https://my-cluster.weaviate.cloud", url);
    }
    ...
    public void customConnectionTypeUsesHostPort() {
        ...
        String url = provider.getConnectionURL(null, cfg);
        Assertions.assertEquals("http://myhost:9999", url);
    }
}
